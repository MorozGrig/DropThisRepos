...
namespace DropThisSite.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMaterial,NameMaterial,Proba")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMaterial,NameMaterial,Proba")] Material material)
        {
